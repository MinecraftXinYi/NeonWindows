...
Console.WriteLine(ProcessDpiContextApi.NtUserSetProcessDpiAwarenessContext((ulong)DPI_AWARENESS_CONTEXT.DPI_AWARENESS_CONTEXT_PER_MONITOR_AWARE_MIXED.Value, Convert.ToByte(false)));
Console.ReadKey();
Console.WriteLine($"CurrentProcessDpiAwarenessMode: {AppDpiAwareness.CurrentProcessDpiAwarenessMode}");
Console.WriteLine($"CurrentThreadDpiAwarenessMode: {AppDpiAwareness2.CurrentThreadDpiAwarenessMode}");
Console.ReadKey();
Console.WriteLine("Testing native api NtUserSetProcessDpiAwarenessContext...2");
Console.WriteLine(ProcessDpiContextApi.NtUserSetProcessDpiAwarenessContext((ulong)DPI_AWARENESS_CONTEXT.DPI_AWARENESS_CONTEXT_PER_MONITOR_AWARE_V2_MIXED.Value, Convert.ToByte(false)));
Console.ReadKey();
Console.WriteLine($"CurrentProcessDpiAwarenessMode: {AppDpiAwareness.CurrentProcessDpiAwarenessMode}");
Console.WriteLine($"CurrentThreadDpiAwarenessMode: {AppDpiAwareness2.CurrentThreadDpiAwarenessMode}");
Console.ReadKey();
Console.WriteLine("Testing native api NtUserSetProcessDpiAwarenessContext...3");
Console.WriteLine(ProcessDpiContextApi.NtUserSetProcessDpiAwarenessContext((ulong)DPI_AWARENESS_CONTEXT.DPI_AWARENESS_CONTEXT_PER_MONITOR_AWARE_V2_MIXED.Value, Convert.ToByte(true)));
Console.ReadKey();
Console.WriteLine($"CurrentProcessDpiAwarenessMode: {AppDpiAwareness.CurrentProcessDpiAwarenessMode}");
Console.WriteLine($"CurrentThreadDpiAwarenessMode: {AppDpiAwareness2.CurrentThreadDpiAwarenessMode}");
Console.ReadKey();
