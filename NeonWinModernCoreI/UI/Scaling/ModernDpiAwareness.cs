...
public static class ModernDpiAwareness
{
    ...
    public static bool SetProcessPerMonitorDpiAware(out bool isPerMonitorV2)
    {
        ...
        if (AppDpiAwareness2.SetCurrentProcessDpiAwarenessModeEx(DpiAwarenessMode.PerMonitorV2, true))
        {
            isPerMonitorV2 = true;
            return true;
        }
        return AppDpiAwareness2.SetCurrentProcessDpiAwarenessModeEx(DpiAwarenessMode.PerMonitor, true);
    }
    ...
    public static bool SetThreadPerMonitorDpiAware(out bool isPerMonitorV2)
    {
        ...
        return AppDpiAwareness2.SetCurrentThreadDpiAwarenessMode(DpiAwarenessMode.PerMonitor);
    }
}
