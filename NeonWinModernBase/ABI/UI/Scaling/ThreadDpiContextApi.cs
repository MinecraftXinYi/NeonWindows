...
{
    /// <summary>
    /// 获取当前线程的 DPI_AWARENESS_CONTEXT 。
    /// </summary>
    /// <returns>线程的当前 DPI_AWARENESS_CONTEXT 。</returns>
    ...
    /// </summary>
    /// <param name="dpiContext">当前线程的新 DPI_AWARENESS_CONTEXT 。 此上下文包括 DPI_AWARENESS 值。</param>
    /// <returns>线程的旧 DPI_AWARENESS_CONTEXT 。 如果 dpiContext 无效，则不会更新线程，并且返回值为 NULL。</returns>
    [DllImport(Win32DllName.ExtMsWinRTCoreNtUserDPIL120, ExactSpelling = true)]
    [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
